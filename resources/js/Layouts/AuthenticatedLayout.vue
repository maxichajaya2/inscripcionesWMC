        ...
        <aside :class="[isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full']"
            ...
            <nav class="flex-1 px-4 py-8 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <div v-if="isAdmin" class="pt-6">
                    ...
                    <Link :href="route('multieventos.index')"
                        class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all mt-1"
                        :class="route().current('multieventos.index') ? 'bg-blue-600 text-white shadow-lg shadow-blue-900/50' : 'text-blue-200 hover:bg-blue-900/50 hover:text-white'">
                        ...
                        <span class="tracking-wide">MultiEventos</span>
                    </Link>

                    <Link :href="route('sie.index')"
                        class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all mt-1"
                        :class="route().current('sie.index') ? 'bg-blue-600 text-white shadow-lg shadow-blue-900/50' : 'text-slate-300 hover:bg-slate-800 hover:text-white'">
                        ...
                        <span class="tracking-wide">SIE</span>
                    </Link>
